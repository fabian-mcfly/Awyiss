...
trait ExistsTrait {
	 ...
	 *
	 * @param \Cake\Database\ExpressionInterface|\Closure|array|string|null $aa_conditions The conditions to use for checking if any record matches.
	 * @param array $aa_options Additional options to pass to the exists() method of the table
	 * @return bool
	 * @see Table::exists
	 */
	public function exists(ExpressionInterface|Closure|array|string|null $aa_conditions, array $aa_options = []): bool {
