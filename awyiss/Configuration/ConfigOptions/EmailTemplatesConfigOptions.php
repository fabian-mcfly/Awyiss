...
/**
 * Provides all configuration options for the email templates scope
 */
class EmailTemplatesConfigOptions extends AbstractConfigOptions {
	 ...
	 */
	protected static string $scope = 'EmailTemplates';
