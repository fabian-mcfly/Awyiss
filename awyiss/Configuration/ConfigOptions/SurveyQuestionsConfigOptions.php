...
/**
 * Provides all configuration options for the survey questions scope
 */
class SurveyQuestionsConfigOptions extends AbstractConfigOptions {
	 ...
	 */
	protected static string $scope = 'SurveyQuestions';
