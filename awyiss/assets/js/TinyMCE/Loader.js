...
export default class Loader {
	...
	settings = {
		...
		plugins: 'anchor autolink autoresize charmap code link lists nonbreaking table visualblocks visualchars wordcount',
		relative_urls: true,
		...
		toolbar2: 'link unlink anchor | blockquote bullist numlist | hr subscript superscript nonbreaking charmap | table | visualblocks visualchars | wordcount code',
		toolbar_sticky: true,
