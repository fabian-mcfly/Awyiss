 ...
 * @property \Awyiss\Model\Entity\MediaCompositeAssignment[] $mediaCompositeAssignments
 * @property \Awyiss\Model\Entity\MediaCompositeSelector[] $mediaCompositeSelectors
 */
class MediaComposite extends Entity {
	/**
	...
	protected static array $fieldMap = [
		...
		'media_composite_assignments' => 'mediaCompositeAssignments',
		'media_composite_selectors' => 'mediaCompositeSelectors',
	];
	...
	protected array $_accessible = [
		...
		'systemOrder' => true,
		'active' => true,
		'mediaCompositeAssignments' => true,
		'mediaCompositeSelectors' => true,
	];
	/**
	 * @inheritdoc
	 */
