...
class Menu {
	...
	public function appendEntries (array $aa_entries, string $as_identifier) {
	...
	public function getItem (string|int $id): ?MenuItem {
	...
	public function insertEntriesAfter (array $aa_entries, string $as_identifier = NULL): void {
		if ($as_identifier) {
		...
		$lo_newMenu = new static($aa_entries, $this->getConfig(), $this->level);
