...
/**
 * Class MediaCompositeAssignments
 */
class MediaCompositeAssignments {
	/**
	...
	public function up(): void {
		$this->migration->table('media_composite_assignments')->addColumn('id', 'integer', [
			'autoIncrement' => true,
			'default' => null,
			'limit' => null,
			'null' => false,
	...
	public function down(): void {
		$this->migration->table('media_composite_assignments')->drop()->save();
	}
}
