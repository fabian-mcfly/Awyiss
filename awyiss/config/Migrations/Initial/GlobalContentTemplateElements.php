...
class GlobalContentTemplateElements {
	...
	public function up(): void {
		if ($this->migration->hasTable('global_content_template_elements')) {
			$this->migration->table('global_content_template_elements')->drop()->save();
		}

		$this->migration->table('global_content_template_elements')->addColumn('id', 'integer', [
			'autoIncrement' => true,
			'default' => null,
			'limit' => null,
			'null' => false,
			'signed' => true,
		])->addPrimaryKey(['id'])->addColumn('global_content_template_id', 'integer', [
			'default' => null,
			'limit' => null,
			'null' => false,
			'signed' => true,
