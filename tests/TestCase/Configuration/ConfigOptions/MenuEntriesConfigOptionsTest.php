...
use Awyiss\Configuration\ConfigOptions\MenuEntriesConfigOptions;
use Awyiss\Configuration\ConfigOptionType;
use Awyiss\Test\TestSuite\TestCase;


/**
 * MenuEntriesConfigOptions Test Case
 *
 * @see \Awyiss\Configuration\ConfigOptions\MenuEntriesConfigOptions
 */
class MenuEntriesConfigOptionsTest extends TestCase {
	use FlattenConfigOptionsTrait;


	/**
	 * @var \Awyiss\Configuration\ConfigOptions\MenuEntriesConfigOptions
	 */
	protected MenuEntriesConfigOptions $configOptions;
	...
	protected function setUp(): void {
		...
		$this->configOptions = new MenuEntriesConfigOptions();
	}
