...
use Awyiss\Configuration\ConfigOptions\DashboardElementsConfigOptions;
use Awyiss\Configuration\ConfigOptionType;
use Awyiss\Test\TestSuite\TestCase;


/**
 * DashboardElementsConfigOptions Test Case
 *
 * @see \Awyiss\Configuration\ConfigOptions\DashboardElementsConfigOptions
 */
class DashboardElementsConfigOptionsTest extends TestCase {
	use FlattenConfigOptionsTrait;


	/**
	 * @var \Awyiss\Configuration\ConfigOptions\DashboardElementsConfigOptions
	 */
	protected DashboardElementsConfigOptions $configOptions;
	...
	protected function setUp(): void {
		...
		$this->configOptions = new DashboardElementsConfigOptions();
	}
