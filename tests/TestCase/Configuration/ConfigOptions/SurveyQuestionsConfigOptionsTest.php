...
use Awyiss\Configuration\ConfigOptions\SurveyQuestionsConfigOptions;
use Awyiss\Configuration\ConfigOptionType;
use Awyiss\Test\TestSuite\TestCase;


/**
 * SurveyQuestionsConfigOptions Test Case
 *
 * @see \Awyiss\Configuration\ConfigOptions\SurveyQuestionsConfigOptions
 */
class SurveyQuestionsConfigOptionsTest extends TestCase {
	use FlattenConfigOptionsTrait;


	/**
	 * @var \Awyiss\Configuration\ConfigOptions\SurveyQuestionsConfigOptions
	 */
	protected SurveyQuestionsConfigOptions $configOptions;
	...
	protected function setUp(): void {
		...
		$this->configOptions = new SurveyQuestionsConfigOptions();
	}
