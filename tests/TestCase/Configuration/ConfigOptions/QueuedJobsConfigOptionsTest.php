...
use Awyiss\Configuration\ConfigOptions\QueuedJobsConfigOptions;
use Awyiss\Configuration\ConfigOptionType;
use Awyiss\Test\TestSuite\TestCase;


/**
 * QueuedJobsConfigOptions Test Case
 *
 * @see \Awyiss\Configuration\ConfigOptions\QueuedJobsConfigOptions
 */
class QueuedJobsConfigOptionsTest extends TestCase {
	use FlattenConfigOptionsTrait;


	/**
	 * @var \Awyiss\Configuration\ConfigOptions\QueuedJobsConfigOptions
	 */
	protected QueuedJobsConfigOptions $configOptions;
	...
	protected function setUp(): void {
		...
		$this->configOptions = new QueuedJobsConfigOptions();
	}
