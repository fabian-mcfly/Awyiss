...
use Awyiss\Configuration\ConfigOptions\ContentTemplatesConfigOptions;
use Awyiss\Configuration\ConfigOptionType;
use Awyiss\Test\TestSuite\TestCase;


/**
 * ContentTemplatesConfigOptions Test Case
 *
 * @see \Awyiss\Configuration\ConfigOptions\ContentTemplatesConfigOptions
 */
class ContentTemplatesConfigOptionsTest extends TestCase {
	use FlattenConfigOptionsTrait;


	/**
	 * @var \Awyiss\Configuration\ConfigOptions\ContentTemplatesConfigOptions
	 */
	protected ContentTemplatesConfigOptions $configOptions;
	...
	protected function setUp(): void {
		...
		$this->configOptions = new ContentTemplatesConfigOptions();
	}
	...
	public function testInitializeConfigOptions(): void {
		...
		$this->assertSame('content_templates::file_name', $configOptions['Backend.overview.displayedFields']->getPrintableValue());
		...
		$this->assertSame([
			'file_name' => 'content_templates::file_name',
			'in_content_row' => 'content_templates::in_content_row',
			'system_order' => 'content_templates::system_order',
			'active' => 'content_templates::active',
			'created_by' => 'content_templates::created_by',
			'created_on' => 'content_templates::created_on',
			'changed_by' => 'content_templates::changed_by',
			'changed_on' => 'content_templates::changed_on',
