...
class ContentsCellTest extends TestCase {
	...
	public function testCacheAssignedMediaItemsIncludingInactiveItemsInPreviewMode(): void {
		...
		$this->assertCount(8, $resizedFiles[4]);
	}
	...
	public function testDisplayWithColumnWidth(): void {
		...
		$this->assertStringNotContainsString('data-src="_resized/dummypath/logo-awyiss-[w1440].webp" alt="logo-awyiss.png"', $output);
		$this->assertStringContainsString('data-src="../awyiss/Command/Media/TestFiles/_resized/logo-awyiss-[w864].webp"', $output);
