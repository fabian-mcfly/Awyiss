...
class LinkSelectWidgetTest extends TestCase {
	...
	public function testRender(): void {
		...
		$expected = '<div class="LinkSelect LinkSelect-Test" id="TestId">' .
			'<label class="Label" tabindex="0"><strong>Test Label</strong></label>' .
			'<ul class="List">' .
			'<li class="Item Item-Option1"></li>' .
			...
			'<li class="Item Item-News IsGrouped">/backend/de/news/overview/category:184/</li>' .
			'<li additional-attribute="additional-value" class="Item Item-Updates Active IsGrouped">/backend/de/updates/overview/category:185/</li>' .
			'<li class="Item Item-Announcements">/backend/de/announcements/overview/category:186/</li>' .
			...
			'<li disabled="disabled" class="Item Item-Events IsGrouped">/backend/de/events/overview/category:187/</li>' .
			'<li class="Item Item-Meetings IsGrouped">/backend/de/meetings/overview/category:188/</li>' .
			'<li class="Item Item-Conferences">/backend/de/conferences/overview/category:189/</li></ul></div>';
