...
/**
 * Test case for RoutePlannerModule
 *
 * @see \Awyiss\Module\RoutePlannerModule
 */
class RoutePlannerModuleTest extends TestCase {
	/**
	...
	public function testGetFormFieldsWithCustomSettings(): void {
		...
		$result = RoutePlannerModule::getFormFields($this->mockBackendView, null, null, $settings);
