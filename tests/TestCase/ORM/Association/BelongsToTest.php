...
/**
 * Test case for BelongsTo
 *
 * @see \Awyiss\ORM\Association\BelongsTo
 */
class BelongsToTest extends TestCase {
	/**
	 * @var \Awyiss\ORM\Association\BelongsTo
	 */
	protected BelongsTo $belongsToAssociation;
	/**
	...
	protected function setUp(): void {
		...
		$this->belongsToAssociation = new BelongsTo('User', [
	...
	public function testExistsPassesOptionsToTargetTable(bool $exists): void {
		...
		$result = $this->belongsToAssociation->exists($conditions, $options);
