...
class ContentsListenerTest extends TestCase {
	 ...
	 * @noinspection PhpVariableNamingConventionInspection
	 */
	public function testBeforeSaveFixesAnchorLinks(): void {
		/** @noinspection HtmlUnknownAnchorTarget */
		$entity = $this->fetchTable('Contents')->newDefaultEntity([
			'text' => '<a href="#section1">Section 1</a>',
			'pageId' => 20,
		]);
		...
		/** @noinspection HtmlUnknownAnchorTarget */
		$this->assertSame('<a href="de/kundenbereich/registrierung/#section1">Section 1</a>', $entity->text);
	}
	 ...
	 * @noinspection PhpVariableNamingConventionInspection
	 */
	public function testBeforeSaveFixesAnchorLinksInAttributesOfInputTypeTexteditor(): void {
		/** @noinspection HtmlUnknownAnchorTarget */
		$entity = $this->fetchTable('Contents')->newDefaultEntity([
			'teaser' => '<a href="#section1">Section 1</a>',
			'freeText' => '<a href="#section1">Section 1</a>',
			'pageId' => 20,
		]);
		...
		/** @noinspection HtmlUnknownAnchorTarget */
		$this->assertSame('<a href="de/kundenbereich/registrierung/#section1">Section 1</a>', $entity->teaser);
		/** @noinspection HtmlUnknownAnchorTarget */
		$this->assertSame('<a href="#section1">Section 1</a>', $entity->freeText);
	}
	 ...
	 * @noinspection PhpVariableNamingConventionInspection
	 */
	public function testBeforeSaveFixesAnchorLinksOnHomepage(): void {
		/** @noinspection HtmlUnknownAnchorTarget */
		$entity = $this->fetchTable('Contents')->newDefaultEntity([
			'text' => '<a href="#section1">Section 1</a>',
			'pageId' => 1,
		...
		/** @noinspection HtmlUnknownAnchorTarget */
		$this->assertSame('<a href="de/startseite/#section1">Section 1</a>', $entity->text);
	}
	 ...
	 * @noinspection PhpVariableNamingConventionInspection
	 */
	public function testBeforeSaveFixesAnchorLinksOnUnknownPage(): void {
		/** @noinspection HtmlUnknownAnchorTarget */
		$entity = $this->fetchTable('Contents')->newDefaultEntity([
			'text' => '<a href="#section1">Section 1</a>',
			'pageId' => 999,
		...
		/** @noinspection HtmlUnknownAnchorTarget */
		$this->assertSame('<a href="#section1">Section 1</a>', $entity->text);
	}
}
