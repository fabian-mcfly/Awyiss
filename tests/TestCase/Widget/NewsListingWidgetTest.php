...
/**
 * Test case for NewsListingWidget
 *
 * @see \Awyiss\Widget\NewsListingWidget
 */
class NewsListingWidgetTest extends TestCase {
	/**
	 ...
	 *
	 * @return void
	 * @see \Awyiss\Widget\NewsListingWidget::getTitle()
	 */
	public function testGetTitle(): void {
		$result = NewsListingWidget::getTitle();
	 ...
	 *
	 * @return void
	 * @see \Awyiss\Widget\NewsListingWidget::getFormFields()
	 * @throws \PHPUnit\Framework\MockObject\Exception
	 */
	 ...
	 *
	 * @return void
	 * @see \Awyiss\Widget\NewsListingWidget::isAvailable()
	 */
	public function testIsAvailable(): void {
		$result = NewsListingWidget::isAvailable();
	 ...
	 *
	 * @return void
	 * @see \Awyiss\Widget\NewsListingWidget::render()
	 * @throws \PHPUnit\Framework\MockObject\Exception
	 */
	public function testRenderWithDefaultSettings(): void {
		...
		$result = NewsListingWidget::render(
			$settings,
