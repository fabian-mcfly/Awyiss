 ...
 * Employees Model
 *
 * @method \FoobarCustomer\Model\Entity\Employee newDefaultEntity(array $additionalData = [], array $options = [])
 ...
 * @method \FoobarCustomer\Model\Entity\Employee getParent(\Cake\Datasource\EntityInterface $entity, array $options = [])
...
class EmployeesTable extends GenericDatatablesTable {
	/**
	 * @inheritDoc
	 */
