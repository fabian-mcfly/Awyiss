...
* Promotions Model
*
* @property PromotionsTable&BelongsTo $ParentPromotions
* @property PromotionsTable&HasMany $ChildPromotions
* @property PromotionsTable&HasMany $DuplicatePromotions
* @property PromotionsTable&BelongsTo $DuplicateOfPromotions
...
*/
class PromotionsTable extends PagesTable {
	/**
	* @inheritDoc
	*/
	protected string $pageRole = 'promotion';
